...
DROP SEQUENCE RS_SQ;
CREATE TABLE HOTEL(
  hotelCode VARCHAR2(30) PRIMARY KEY,
...
INSERT INTO HOTEL VALUES ('yongsan novotel', '노보텔엠버서드','용산',null, null, null, null, null, null, 4.8);
INSERT INTO HOTEL VALUES ('ramada sokcho', '라마다호텔','속초',null, null, null, null, null, null, 4.6);
CREATE TABLE ROOM(
  roomCODE NUMBER(5) PRIMARY KEY,
  hotelCODE VARCHAR2(30) REFERENCES HOTEL(HOTELCODE),
...
SELECT * FROM HOTEL;
INSERT INTO ROOM VALUES (1,'yongsan novotel', '프리미엄','A',3000000,6,NULL, NULL, NULL, NULL, NULL);
INSERT INTO ROOM VALUES (2,'yongsan novotel', '디럭스','B',250000,4,NULL, NULL, NULL, NULL, NULL);
INSERT INTO ROOM VALUES (3,'yongsan novotel', '수페리어룸','C',200000,2,NULL, NULL, NULL, NULL, NULL);
INSERT INTO ROOM VALUES (4,'ramada sokcho', '디럭스패밀리더블','A',300000,6,NULL, NULL, NULL, NULL, NULL);
INSERT INTO ROOM VALUES (5,'ramada sokcho', '스텐다드더블','B',150000,4,NULL, NULL, NULL, NULL, NULL);
INSERT INTO ROOM VALUES (6,'ramada sokcho', '스텐다드트윈','C',100000,2,NULL, NULL, NULL, NULL, NULL);
SELECT * FROM ROOM;
CREATE TABLE MEMBER(
